...
import { getPastTickets } from "api/requests/tickets/getPastTickets";
...
export const PastTickets: FC = memo(() => {
  ...
  const fetchFunc = useCallback(
    async (pageParam: unknown) => {
      ...
      return await getPastTickets(params, accessToken, isAdmin);
    },
    [accessToken, isAdmin]
  );
  ...
  const {
    ...
    queryKey: [QueryKeys.GetPastTickets, user],
